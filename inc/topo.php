	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
		...
		<style>
			<?php
				...
				$hora = date("G");
				if ($hora >= 6 && $hora < 12) echo "body, .lateral, .comentariosPost, .teste {background-color:rgb(61,103, 255);}"; //Dia
				elseif ($hora >= 12 && $hora < 19) echo "body, .lateral, .comentariosPost, .teste {background-color:rgb(237, 122, 17);}"; //Tarde
				else echo "body, .lateral, .comentariosPost, .teste {background-color:rgb(147,112,219);}"; //Noite
			?>
		</style>
